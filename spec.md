# TOC
   ...
   - [ObjectMonitor](#objectmonitor)
     - [.proxy()](#objectmonitor-proxy)
       ...
       - [[map-proxy].keys()](#objectmonitor-proxy-map-proxykeys)
   ...
   - [SimpleBucketStorage](#simplebucketstorage)
     - [.init(type, args)](#simplebucketstorage-inittype-args)
     - [.trans(v, p, u) -> {v, r, eff}](#simplebucketstorage-transv-p-u---v-r-eff)
     - [context](#simplebucketstorage-context)
       - [.init(type, args)](#simplebucketstorage-context-inittype-args)
       - [.trans(v, p, u) -> {v,r,eff}](#simplebucketstorage-context-transv-p-u---vreff)
       - [.conflict(msg)](#simplebucketstorage-context-conflictmsg)
       - [.effect(p)](#simplebucketstorage-context-effectp)
       - [.self()](#simplebucketstorage-context-self)
       - [.clone(obj)](#simplebucketstorage-context-cloneobj)
   ...
   - [createValidatingBucket(createBucket)](#createvalidatingbucketcreatebucket)
     - [.store(obj, emit)](#createvalidatingbucketcreatebucket-storeobj-emit)
     - [.storeIncoming(v, p, monitor, r, eff, emit)](#createvalidatingbucketcreatebucket-storeincomingv-p-monitor-r-eff-emit)
     - [.storeOutgoing(v, p, monitor, r, eff, emit)](#createvalidatingbucketcreatebucket-storeoutgoingv-p-monitor-r-eff-emit)
     - [.storeInternal(v, p, monitor, r, eff, emit)](#createvalidatingbucketcreatebucket-storeinternalv-p-monitor-r-eff-emit)
     - [.checkCache(v, p)](#createvalidatingbucketcreatebucket-checkcachev-p)
     - [.retrieve(id)](#createvalidatingbucketcreatebucket-retrieveid)
     - [.add(elem)](#createvalidatingbucketcreatebucket-addelem)
<a name=""></a>
...
<a name="objectmonitor-proxy-map-proxykeys"></a>
### [map-proxy].keys()
should return an array of the keys in the map.
...
<a name="reliablequeue"></a>
# ReliableQueue
<a name="reliablequeue-pushelem"></a>
## .push(elem)
should return a time-uuid.
...
should clear the elements so that further calls do not retrieve the same items.
...
should also return elements pushed by a previous (crashed) instance looking at the same directory.
...
## .acknowledge(tuid)
should not repeat acknowledged elements.
...
should not repeat more than a given number of acknowledged elements when recovering from failure.
...
should recover all elements since the acknowledgement.
...
<a name="simplebucketstorage-inittype-args"></a>
## .init(type, args)
should return a version ID of a newly created object.
...
<a name="simplebucketstorage-transv-p-u---v-r-eff"></a>
## .trans(v, p, u) -> {v, r, eff}
should return the value returned from the method corresponding to patch p.
...
<a name="simplebucketstorage-context"></a>
## context
<a name="simplebucketstorage-context-inittype-args"></a>
### .init(type, args)
should initialize an object with the given type and args and return its version ID.
...
<a name="simplebucketstorage-context-transv-p-u---vreff"></a>
### .trans(v, p, u) -> {v,r,eff}
should transform a version and return the new version ID and result.
...
<a name="simplebucketstorage-context-conflictmsg"></a>
### .conflict(msg)
should throw an exception with .isConflict set to true.
...
<a name="simplebucketstorage-context-effectp"></a>
### .effect(p)
should add patch p to the effect sequence.
...
<a name="simplebucketstorage-context-self"></a>
### .self()
should return the version ID of the object prior to this patch application.
...
<a name="simplebucketstorage-context-cloneobj"></a>
### .clone(obj)
should return a value equivalent to obj but not a reference.
...
<a name="createvalidatingbucketcreatebucket"></a>
# createValidatingBucket(createBucket)
<a name="createvalidatingbucketcreatebucket-storeobj-emit"></a>
## .store(obj, emit)
should consult the underlying .store() method.
...
## .storeIncoming(v, p, monitor, r, eff, emit)
should consult the underlying .storeIncoming() method.
...
## .storeOutgoing(v, p, monitor, r, eff, emit)
should consult the underlying .storeIncoming() method.
...
## .storeInternal(v, p, monitor, r, eff, emit)
should consult the underlying .storeIncoming() method.
...
## .checkCache(v, p)
should consult the underlying .checkCache() method.
...
## .retrieve(id)
should consult the underlying .retrieve() method.
